...
def main():
    ...
    images, poses, render_poses, hwf, x_angles = None, None, None, None, None
    i_train, i_val, i_test = None, None, None
    if cfg.dataset.type.lower() == "blender":
        # Load blender dataset
        images, poses, render_poses, hwf, i_split, x_angles = load_blender_data(
            cfg.dataset.basedir,
            half_res=cfg.dataset.half_res,
            testskip=cfg.dataset.testskip,
            x_angle=configargs.x_angle,
            y_angle=configargs.y_angle,
            frames=configargs.frames
        )
    ...
    for i, pose in enumerate(tqdm(render_poses)):
        ...
        if configargs.savedir:
            ...
            dict2 = {"frame":{"path":savefile,"x":x_angles[i],"y":configargs.y_angle}}
            dictall.append(dict2)
            if configargs.save_disparity_image:
    ...
    dictall = json.dumps(dictall, indent=4)
    with open("test.json", "w") as outfile:
        outfile.write(dictall)
